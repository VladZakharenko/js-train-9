...
function findLastEvenNumber(arr) {
  if (Array.isArray(arr)) {
    ...
    return arr.findLast((elem) => elem % 2 === 0) ? arr.findLast((elem) => elem % 2 === 0) : 'Парних чисел не знайдено'
...
console.log(findLastEvenNumber([1, 3, 3, 7, 5])); // Виведе 4
...
function flattenSquareAndFilter(arr, threshold) {
  ...
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні повертаємо 'Вхідний параметр має бути масивом'
  let arr1 = arr.flat()
  let arr2 = arr1.map((elem) => elem ** 2)
  let arr3 = arr2.filter((elem) => elem > threshold)
  return arr3
...
function wordLengths(arr) {
  ...
  let nArr = arr.map((elem) => elem.length)
  return nArr
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо 'Вхідний параметр має бути масивом'
...
function expandArrayByN(arr, n) {
  ...
  let arr1 = arr.flatMap((elem) => Array(n).fill(elem))
  return arr1
...
function findDuplicateElements(arr) {
  ...
  let arr1 = arr.filter((elem, index) => index !== arr.indexOf(elem));
  return arr1
...
function capitalizeWords(arr) {
  ...
  let arr1 = arr.map(elem => {
    ...
    let fLeter = elem[0].toUpperCase()
    let rLetters = elem.slice(1)
    return fLeter + rLetters
...
function findLastNegativeNumberIndex(arr) {
  ...
  let lIndex = arr.findLastIndex((elem) => elem < 0)
  // Перевіряємо, чи вхідний параметр є масивом, якщо ні, повертаємо -1
